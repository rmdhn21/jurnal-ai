...
const workoutData = {
    ...
    gym1: [
        { id: 'g1_1', text: 'Barbell Squat', sets: '3 Set x 5-8 Reps', how: 'Taruh barbell di punggung atas. Turun perlahan seperti mau duduk, dorong kuat ke atas.', benefit: 'Membangun tenaga ledak (power). Untuk BOLA: Lari sprint & power tendangan. Untuk VOLI: Meningkatkan daya ledak Vertical Jump saat memblok atau smash.', img: 'img/workouts/barbell_squat.png' },
        { id: 'g1_2', text: 'Romanian Deadlift (RDL)', sets: '3 Set x 8-10 Reps', how: 'Tekuk lutut sedikit, dorong pantat ke belakang sampai punggung rata, rasakan tarikan di paha belakang.', benefit: 'Memperkuat Hamstring. Untuk BOLA: Rem alami saat lari kencang. Untuk VOLI: Meredam benturan lutut saat mendarat dari lompatan tinggi.', img: 'img/workouts/romanian_deadlift.png' },
        { id: 'g1_3', text: 'Calf Raises (Jinjit Beban)', sets: '3 Set x 12-15 Reps', how: 'Pegang beban, turunkan tumit dari pijakan, lalu jinjit setinggi mungkin.', benefit: 'Betis kuat. Untuk BOLA: Akselerasi langkah pertama. Untuk VOLI: Menambah beberapa sentimeter ekstra pada lompatan vertikalmu.', img: 'img/workouts/calf_raises.png' },
        { id: 'g1_4', text: 'Hanging Leg Raise', sets: '3 Set x 10-12 Reps', how: 'Bergelantungan di bar, angkat kaki lurus ke depan sejajar perut (atau tekuk lutut jika berat).', benefit: 'Core stabil. BOLA: Menstabilkan pinggul saat lari. VOLI: Memberikan "hang time" (waktu melayang) lebih lama dan postur stabil saat memukul bola di udara.', img: 'img/workouts/hanging_leg_raise.png' }
    ],
    gym2: [
        { id: 'g2_1', text: 'Pemanasan Rotator Cuff', sets: '2 Set x 15 Reps', how: 'Gunakan kabel gym paling ringan. Siku tempel di rusuk, rotasi lengan ke arah luar badan.', benefit: 'Penyelamat Karir! Melumasi sendi bahu agar tidak robek saat melakukan ayunan smash/spike voli yang sangat eksplosif.', img: 'img/workouts/rotator_cuff_warmup.png' },
        { id: 'g2_2', text: 'Lat Pulldown / Pull Up', sets: '3 Set x 6-10 Reps', how: 'Tarik beban dari atas ke arah dada, rapatkan tulang belikat.', benefit: 'Punggung V-Shape. BOLA: Menang adu bodi (shielding). VOLI: Otot Lats adalah penyumbang tenaga terbesar saat tanganmu mengayun ke bawah saat smash.', img: 'img/workouts/lat_pulldown.png' },
        { id: 'g2_3', text: 'Dumbbell Shrugs (Traps)', sets: '3 Set x 10-12 Reps', how: 'Pegang dumbbell, angkat bahu ke arah telinga. Tahan 1 detik.', benefit: 'Pundak kuat. BOLA: Meminimalisir cedera leher saat menyundul. VOLI: Meredam benturan saat terjatuh/rolling ke lantai menyelamatkan bola.', img: 'img/workouts/dumbbell_shrugs.png' },
        { id: 'g2_4', text: 'Face Pulls (Rear Delt)', sets: '3 Set x 12-15 Reps', how: 'Tarik tali kabel setinggi wajah ke arah hidung sambil membuka siku lebar ke belakang.', benefit: 'Menarik bahu ke belakang. Mencegah bahu melengkung ke depan karena terlalu sering melakukan gerakan memukul/smash (postur tubuh tetap tegap).', img: 'img/workouts/face_pulls.png' },
        { id: 'g2_5', text: 'Dumbbell Lateral Raise', sets: '3 Set x 10-12 Reps', how: 'Angkat dumbbell ringan lurus ke samping badan. Jangan diayun!', benefit: 'Bahu samping bulat & kokoh. BOLA: Kokoh saat benturan udara. VOLI: Kekuatan tambahan saat melakukan blocking di net.', img: 'img/workouts/dumbbell_lateral_raise.png' }
    ],
    home1: [
        { id: 'h1_1', text: 'Wall Sit (Tanpa Suara)', sets: '3 Set x 45-60 Detik', how: 'Senderkan punggung di tembok, turunkan badan posisi duduk 90 derajat. Tahan diam.', benefit: 'Endurance paha (100% Sunyi). BOLA: Stamina babak kedua. VOLI: Ketahanan kaki saat harus terus-terusan posisi jongkok rendah menunggu receive/serve lawan.', img: 'img/workouts/wall_sit.png' },
        { id: 'h1_2', text: 'Resistance Band Crab Walk', sets: '3 Set x 15 Langkah', how: 'Ikat band di atas lutut, setengah jongkok, jalan menyamping pelan-pelan.', benefit: 'Kekuatan Pinggul Samping. BOLA: Kelincahan zig-zag. VOLI: Sangat krusial untuk langkah geser (side-step) cepat saat nge-block dari ujung ke ujung net.', img: 'img/workouts/crab_walk.png' },
        { id: 'h1_3', text: 'Glute Bridge (Tanpa Suara)', sets: '3 Set x 15 Reps', how: 'Rebahan, tekuk lutut, dorong pinggul ke atas sampai kencang.', benefit: 'Membangun stabilitas bokong. Menghasilkan tenaga dorongan dari bawah ke atas tanpa perlu melompat berisik di kamar.', img: 'img/workouts/glute_bridge.png' },
        { id: 'h1_4', text: 'Plank & Side Plank', sets: '3 Set x 45 Detik', how: 'Tahan badan sejajar lantai dengan tumpuan siku.', benefit: 'BOLA: Tembok pertahanan saat didorong. VOLI: Memberikan kontrol tubuh sempurna saat harus spike di posisi bola yang tidak ideal (off-balance).', img: 'img/workouts/plank.png' }
    ],
    home2: [
        { id: 'h2_1', text: 'Band Pull Aparts', sets: '3 Set x 15-20 Reps', how: 'Pegang band di depan dada, tarik memisah ke samping sampai menyentuh dada.', benefit: 'Bahu belakang kuat. Sangat penting bagi pemain voli agar bahu tidak cedera karena over-use di bagian depan (dada/depan bahu).', img: 'img/workouts/band_pull_aparts.png' },
            ...
            <div class="workout-task-card" style="background: ${isDone ? colorHex + '11' : 'var(--bg-card)'}; border: 1px solid ${isDone ? colorHex + '33' : 'var(--border)'}; border-radius: var(--radius-md); transition: all 0.2s ease;">
                ...
                ${isExpanded ? `
                    <div style="padding: 0 15px 15px 54px; border-top: 1px solid rgba(255,255,255,0.05); margin-top: 0; padding-top: 10px;">
                        ${task.img ? `
                            <div style="margin-bottom: 15px; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1); background: #000; box-shadow: 0 4px 20px rgba(0,0,0,0.4);">
                                <img src="${task.img}" alt="${task.text}" style="width: 100%; height: auto; display: block; filter: brightness(0.9) contrast(1.1);">
                            </div>
                        ` : ''}
